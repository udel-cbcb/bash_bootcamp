...
First, [click here](./bash_bootcamp.zip) to download the materials you will need to complete the hands-on tutorial.  Place the zipped folder on your Desktop and unzip it.
